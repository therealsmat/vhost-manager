...
class NewApacheSiteCommand extends CommandStructure implements SiteInterface {
    ...
    {
        $this->setName('new:apache-site')
            ->setDescription('Creates a new Apache virtual host configuration for a new site');
